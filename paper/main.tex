...
\resizebox{\linewidth}{!}{\input{../results/full_scale/table_main_geometry.tex}}
\label{tab:main}
\end{table}
...
\resizebox{\linewidth}{!}{\input{../results/full_scale/table_calibration.tex}}
...
\resizebox{\linewidth}{!}{\input{../results/full_scale/table_corruption.tex}}
...
\resizebox{\linewidth}{!}{\input{../results/full_scale/table_external_occluders.tex}}
\label{tab:external}
\end{table}
...
\resizebox{\linewidth}{!}{\input{../results/full_scale/table_association.tex}}
...
\resizebox{\linewidth}{!}{\input{../results/full_scale/table_hidden_motion.tex}}
\label{tab:hidden}
\end{table}
